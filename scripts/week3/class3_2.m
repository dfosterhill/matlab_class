...
%you can 'nest' loops
%example, make a gaussian 'bump' and plot it.
...
%Note: the execution time is about the same...This is pretty sneaky of
%Matlab. Years ago, this 'nested loop' approach would have been really
%slow, since more than 1 million calculations are being carried out.
%However, now, Matlab automatically looks for code inefficiecies (and
%nested loops are very inefficient) and corrects them automatically...
...
%can you also 'count' by fractions of an integer? For example
